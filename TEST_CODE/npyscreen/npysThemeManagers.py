...
class ThemeManager(object):
    ...
    default_colors = {
        ...
        'MAGENTA' : 'MAGENTA_BLACK',
        'BOLDGREEN'   : 'GREEN_BLACK',
        'BOLDRED'   : 'RED_BLACK',
        'BOLDYELLOW'   : 'YELLOW_BLACK',
        'BOLDBLUE'   : 'BLUE_BLACK',
        'BOLDCYAN'   : 'CYAN_BLACK',
        'BOLDMAGENTA'   : 'MAGENTA_BLACK',
        'BOLDWHITE'   : 'WHITE_BLACK',
    }
    def __init__(self):
    ...
    def initialize_pairs(self):
        ...
        self._defined_pairs['WHITE_BLACK'] = (
    ...
    def initalize_pair(self, name, fg, bg):
        ''' Initialize a color_pair for the required colour and return
        the number. Raise an exception if this is not possible.'''
